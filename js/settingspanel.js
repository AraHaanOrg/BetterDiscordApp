...
function LoadJSONSettings() {
    ...
    var bdags0 = JSON.stringify(["bdags0"]);
    var bdags1 = JSON.stringify(["bdags1"]);
    var bdags2 = JSON.stringify(["bdags2"]);
    var bdags4 = JSON.stringify(["bdags4"]);
    var bdags3 = JSON.stringify(["bdags3"]);
    var bdaes0 = JSON.stringify(["bdaes0"]);
    var bdaes7 = JSON.stringify(["bdaes7"]);
    var bdaes1 = JSON.stringify(["bdaes1"]);
    var bdaes2 = JSON.stringify(["bdaes2"]);
    var bdaes3 = JSON.stringify(["bdaes3"]);
    var bdaes4 = JSON.stringify(["bdaes4"]);
    var bdaes5 = JSON.stringify(["bdaes5"]);
    var bdaes6 = JSON.stringify(["bdaes6"]);
    var customcss = JSON.stringify(["bdcustomcss"]);
    console.log(bdags0 + bdags1 + bdags2 + bdags4 + bdags3 + bdaes0 + bdaes7 + bdaes1 + bdaes2 + bdaes3 + bdaes4 + bdaes5 + bdaes6 + customcss);
