...
function SaveJSONSettings() {
    ...
    fs.writeFile(file, '{    "bdags0": "' + bdags0 + '",    "bdags1": "' + bdags1 + '",    "bdags2": "' + bdags2 + '",    "bdags4": "' + bdags4 + '",    "bdags3": "' + bdags3 + '",    "bdaes0": "' + bdaes0 + '",    "bdaes7": "' + bdaes7 + '",    "bdaes1": "' + bdaes1 + '",    "bdaes2": "' + bdaes2 + '",    "bdaes3": "' + bdaes3 + '",    "bdaes4": "' + bdaes4 + '",    "bdaes5": "' + bdaes5 + '",    "bdaes6": "' + bdaes6 + '",    "bdcustomcss": "' + customcss + '"}');
}
