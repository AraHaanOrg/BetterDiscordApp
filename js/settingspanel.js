...
function SaveJSONSettings() {
    ...
    fs.writeFile(file, '{    "bdags0": "' + localStorage.getItem("bda-gs-0") +'",    "bdags1": "' + localStorage.getItem("bda-gs-1") + '",    "bdags2": "' + localStorage.getItem("bda-gs-2") + '",    "bdags4": "' + localStorage.getItem("bda-gs-4") + '",    "bdags3": "' +  localStorage.getItem("bda-gs-3") + '",    "bdaes0": "' + localStorage.getItem("bda-es-0") + '",    "bdaes7": "' + localStorage.getItem("bda-es-7") + '",    "bdaes1": "' + localStorage.getItem("bda-es-1") + '",    "bdaes2": "' + localStorage.getItem("bda-es-2") + '",    "bdaes3": "' + localStorage.getItem("bda-es-3") + '",    "bdaes4": "' + localStorage.getItem("bda-es-4") + '",    "bdaes5": "' + localStorage.getItem("bda-es-5") + '",    "bdaes6": "' + localStorage.getItem("bda-es-6") + '",    "bdcustomcss": "' + localStorage.getItem("bdcustomcss") + '"}');
}
